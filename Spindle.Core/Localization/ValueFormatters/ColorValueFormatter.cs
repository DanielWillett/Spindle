...
/// </summary>
public class ColorValueFormatter : IValueStringConverter<Color>, IValueStringConverter<Color32>
{
    ...
    public string Format(IValueStringConvertService formatter, Color value, in ValueFormatParameters parameters)
    {
        return Format(formatter, (Color32)value, in parameters);
    }

    public string Format(IValueStringConvertService formatter, Color32 value, in ValueFormatParameters parameters)
    {
    ...
    private string FormatColorizedRgb(IValueStringConvertService formatter, Color32 value, in ValueFormatParameters parameters)
    {
    ...
    private string FormatColorizedHex(IValueStringConvertService formatter, Color32 value, in ValueFormatParameters parameters)
    {
        if (FormatColorizedHexAuto.Match(in parameters))
        {
            Span<char> span = stackalloc char[8];
            FormatHexColor(span, value);
            return formatter.Colorize(span, value, parameters);
        }
    ...
    private string FormatColorizedHashHex(IValueStringConvertService formatter, Color32 value, in ValueFormatParameters parameters)
    {
