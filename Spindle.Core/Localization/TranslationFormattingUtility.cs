...
internal static class TranslationFormattingUtility
{
...
#pragma warning restore CS8500
    ...
    public static int GetMaximumFormattingArgument(ReadOnlySpan<char> format)
    {
        ReadOnlySpan<char> formatVal = default;
        int argIndex = -1;
        ...
        for (int i = 0; i < format.Length; ++i)
        {
            if (!TrySliceFormatArgument(format, ref i, int.MaxValue, ref argIndex, ref formatVal))
                continue;
