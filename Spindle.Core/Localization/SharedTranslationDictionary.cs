...
public class SharedTranslationDictionary : IDictionary<string, TranslationValue>
{
    ...
    public void Add(string? languageCode, TranslationValue value)
    {
        ...
        if (languageCode != null && !value.Language.Name.Equals(languageCode, StringComparison.OrdinalIgnoreCase))
            throw new ArgumentException(Properties.Resources.SharedTranslationDictionary_LanguageCodesMismatched, nameof(languageCode));
    ...
    public void Add(TranslationValue value)
    {
        if (value == null)
            throw new ArgumentNullException(nameof(value));
        TranslationLanguageKey fullKey = new TranslationLanguageKey(value.Language.Name, Translation.Key);
    ...
    {
        this[value.Language.Name] = value;
    }
    ...
    {
        TranslationLanguageKey fullKey = new TranslationLanguageKey(value.Language.Name, value.Translation.Key);
    ...
    public IEnumerator<KeyValuePair<string, TranslationValue>> GetEnumerator()
    {
        return _underlyingTable
            ...
            .Select(static tableEntry => new KeyValuePair<string, TranslationValue>(tableEntry.Key.LanguageName, tableEntry.Value))
            .GetEnumerator();
    }
    ...
    public void CopyTo(KeyValuePair<string, TranslationValue>[] array, int arrayIndex)
    {
        ...
        if (arrayIndex + Count > array.Length)
            throw new ArgumentException(string.Format(Properties.Resources.SharedTranslationDictionary_ArrayTooShort, Count), nameof(array));
        ...
        foreach (KeyValuePair<TranslationLanguageKey, TranslationValue> tableEntry in _underlyingTable)
        {
            ...
            array[++index] = new KeyValuePair<string, TranslationValue>(tableEntry.Key.LanguageName, tableEntry.Value);
        }
    }
    ...
    private class KeyCollection : ICollection<string>
    {
        ...
        public IEnumerator<string> GetEnumerator() => _instance._underlyingTable.Keys
            ...
            .Select(static tableEntry => tableEntry.LanguageName)
            .GetEnumerator();
