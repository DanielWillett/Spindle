...
/// <summary>
/// The type used for custom logging states.
/// </summary>
public struct SpindleFormattedLogValues
{
    ...
    public IValueStringConvertService? Converter;

    public SpindleFormattedLogValues(string message, object?[] args)
    {
        Parameters = new StringParameterList(args);
        Message = message;
    }

    public SpindleFormattedLogValues(string message, object? arg1)
    {
        Parameters = new StringParameterList(arg1);
        Message = message;
    }

    public SpindleFormattedLogValues(string message, object? arg1, object? arg2)
    {
        Parameters = new StringParameterList(arg1, arg2);
        Message = message;
    }

    public SpindleFormattedLogValues(string message, object? arg1, object? arg2, object? arg3)
    {
        Parameters = new StringParameterList(arg1, arg2, arg3);
        Message = message;
    }

    public SpindleFormattedLogValues(string message, object? arg1, object? arg2, object? arg3, object? arg4)
    {
    ...
    private readonly string FormatIntl(bool useColor)
    {
        ...
        ValueFormatParameters parameters = new ValueFormatParameters(
            ...
            Converter == null ? null! : SpindleLauncher.LanguageService.GetDefaultLanguage(),
        ...
        StackColorFormatType color = !useColor || Converter == null
        ...
        for (int i = 0; i < Parameters.Count; ++i)
        {
            ...
            if (value is IEnumerable enumerable and not string)
            {
                ...
                foreach (object? subValue in enumerable)
                {
                    ...
                    formatted = Converter?.Format(subValue, in parameters, null) ?? subValue?.ToString() ?? default;
